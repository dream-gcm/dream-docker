...
* you'll need to have the command line tools installed on your mac (if not yet installed, i think `xcode-select --install` in the terminal will do it. More info on https://mac.install.guide/commandlinetools/4  if needed.
...
# come back to the DREAM-latest-Docker directory
cd ..

# download some plot tools and tutrials
